...
const jobsData = [
    {
        ...
        requirements: [
            { 
                ...
                reward: '基础薪资 +3000元',
                growthTask: '【任务】完成 30 个页面布局练习（Flexbox、Grid、响应式）+ 通过 FreeCodeCamp 前端认证 + 手写常见 JS 原生方法（防抖、节流、深拷贝等）'
            },
            { 
                id: 'r2', 
                text: '熟练使用 Vue3/React18，掌握组件化开发和状态管理（Pinia/Redux）', 
                reward: '技能薪资 +4000元',
                growthTask: '【任务】完成 3 个完整项目：电商前台（商品列表、购物车、订单）+ 后台管理系统（权限、表格、图表）+ 移动端 H5（适配、性能优化）'
            },
            { 
                id: 'r3', 
                text: '掌握前端工程化：Webpack5/Vite 配置、模块化、代码分割', 
                reward: '工程化薪资 +2500元',
                growthTask: '【任务】从零搭建项目脚手架（支持 TS、热更新、代码压缩、环境变量）+ 优化打包体积至 50% 以下 + 配置 CI/CD 自动部署'
            },
            { 
                id: 'r4', 
                text: 'TypeScript 开发经验，能编写类型安全的代码', 
                reward: '类型安全薪资 +2000元',
                growthTask: '【任务】将 2 个 JS 项目重构为 TS + 掌握泛型、装饰器、类型体操 + 为团队编写 TS 规范文档'
            },
            { 
                id: 'r5', 
                text: '前端性能优化：首屏加载、懒加载、缓存策略，Lighthouse 评分 90+', 
                reward: '性能优化薪资 +2500元',
                growthTask: '【任务】优化 3 个项目性能指标（FCP < 1.5s、LCP < 2.5s、TTI < 3.5s）+ 实现图片懒加载、路由懒加载、CDN 加速 + 输出性能优化方案文档'
            },
            { 
                id: 'r6', 
                text: '熟悉 Git 协作流程、代码规范（ESLint/Prettier）、单元测试（Jest/Vitest）', 
                reward: '协作规范薪资 +2000元',
                growthTask: '【任务】参与 2 个开源项目贡献（提交 PR 并被合并）+ 为项目配置完整的 Lint 和测试环境 + 编写测试覆盖率达 80% 以上'
            }
        ]
    },
    {
    ...
    },
    {
        id: 3,
        title: '产品经理',
        salary: 15000, // 杭州1-3年产品经理中位数：12k-18k
        experience: '1-3年',
        education: '本科',
        tags: ['互联网', '产品'],
        requirements: [
            { 
                ...
                reward: '原型设计薪资 +2500元',
                growthTask: '【任务】设计 10 个完整产品原型（APP 3个、Web 3个、小程序 2个、后台 2个）+ 输出交互说明文档 + 建立组件库和设计规范'
            },
            { 
                id: 'r2', 
                text: '需求分析与用户调研：用户访谈、问卷调查、竞品分析、需求优先级评估', 
                reward: '需求分析薪资 +3000元',
                growthTask: '【任务】完成 10 次用户访谈（录音+文字稿）+ 设计 5 份调查问卷（回收 200+ 份）+ 输出 5 份竞品分析报告 + 使用 KANO 模型评估需求'
            },
            { 
                id: 'r3', 
                text: '产品规划与项目管理：PRD 文档、产品路线图、敏捷开发流程', 
                reward: '项目管理薪资 +2500元',
                growthTask: '【任务】撰写 10 份 PRD 文档（需求背景、功能清单、流程图、异常处理）+ 制定产品路线图 + 主导 3 个项目从 0 到 1 落地'
            },
            { 
                id: 'r4', 
                text: '数据驱动决策：埋点设计、数据分析（神策/GA）、A/B 测试、转化率优化', 
                reward: '数据分析薪资 +2500元',
                growthTask: '【任务】设计完整埋点方案 + 分析 5 个功能数据表现 + 执行 3 次 A/B 测试（提升转化率 20%+）+ 输出月度数据分析报告'
            },
            { 
                id: 'r5', 
                text: '跨部门协作：需求评审、项目推进、资源协调、风险管理', 
                reward: '协作能力薪资 +2000元',
                growthTask: '【任务】组织 20 次需求评审会 + 协调技术、设计、运营资源 + 处理 10 个项目风险问题 + 输出项目复盘报告'
            },
            { 
                id: 'r6', 
                text: '行业洞察与产品思维：关注行业动态、产品方法论（精益、增长黑客）', 
                reward: '产品思维薪资 +2500元',
                growthTask: '【任务】每周输出 1 篇产品分析文章（共 50 篇）+ 拆解 20 个成功产品案例 + 学习《用户体验要素》《启示录》等经典书籍'
            }
        ]
    },
    {
